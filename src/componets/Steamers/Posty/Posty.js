...
function Posty() {
    ...
    return (
        <div className="container">
            ...
            <p>
                Welcome to the world of Posty! Watch the exciting Rust
            ...
            <h2>About Posty</h2>
            <p>
                Posty is a passionate Rust streamer known for his skilled
            ...
            <ul>
                <li>
                    ...
                    <a
                        ...
                        href="https://www.twitch.tv/posty"
                        target="_blank"
                ...
                <li>
                    ...
                    <a
                        ...
                        href="https://twitter.com/postyofficial?lang=bg"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        @posty
                ...
                <li>
                    ...
                    <a
                        ...
                        href="https://www.youtube.com/posty"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        Posty's YouTube Channel
                    </a>
                </li>
            </ul>
