...
const Game = () => {
    ...
    return (
        <div>
            ...
            <div className='rules'>
                <strong><strong><p>You have 15 questions and two fixed amounts: the first is 5 questions and the second is 10.</p><p>You have 3 jokers: 1 50:50 (eliminates two wrong answers) the 2nd is help from the team and the third is ask the Outpost.</p></strong></strong>add
            </div>
