...
function App() {
    ...
    const questions = [
        ...
        {
            question: "How many Heavy Scientists come to the Small Oil Rig when The Locked Crate is released?",
            answers: ["8", "9", "6", "7"],
            correctAnswerIndex: 2,
        },
        {
            question: "How many Heavy Scientists come to the Large Oil Rig when The Locked Crate is released?",
            answers: ["10", "12", "14", "11"],
            correctAnswerIndex: 0,
        },
        {
